...
<head>
    ...
    <title>Manage Products | Pet Dreamland</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-2 bg-light py-2">
                        <span class="fs-5 fw-bold text-dark ">Title</span>
                    </div>
                    <div class="col-4 col-lg-2 d-lg-block bg-light py-2">
                        <span class="fs-5 fw-bold ">Price</span>
                    </div>
                    <div class="col-2 d-none d-lg-block bg-light py-2">
                        <span class="fs-5 fw-bold text-dark">Quantity</span>
                    </div>
                    <div class="col-2 d-none d-lg-block bg-light py-2">
                        <span class="fs-5 fw-bold">Register Date</span>
                    </div>
            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2">
                            <span class="fs-5 fw-bold text-dark"><?php echo $selected_data["qty"]; ?> Items</span>
                        </div>
                        <div class="col-2 d-none d-lg-block bg-light py-2">
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button id="ub<?php echo $selected_data['id']; ?>" class="btn btn-danger" onclick="blockProduct('<?php echo $selected_data['id']; ?>');">Block</button>
                            <?php
                            } else {
                            ?>
                                <button id="ub<?php echo $selected_data['id']; ?>" class="btn btn-success" onclick="blockProduct('<?php echo $selected_data['id']; ?>');">Unblock</button>
                            <?php
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <span class="fs-5 fw-bold mt-2 mb-2">Description :</span>&nbsp;
            ...
            <div class="col-12 text-center">
                <h3 class="text-black fw-bold">Manage Categories</h3>
            </div>
            ...
            <div class="modal" tabindex="-1" id="addCategoryVerificationModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Verrification</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="col-12 mt-3 mb-3">
