...
if (isset($_POST["e"])) {
    ...
    if ($admin_num > 0) {
        ...
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;
        $mail->setFrom('dahamn07@gmail.com', 'Admin Verification');
        $mail->addReplyTo('dahamn07@gmail.com', 'Admin Verification');
        $mail->addAddress($email);
        $mail->isHTML(true);
        $mail->Subject = 'Pet Dreamland Admin Login Verification Code';
