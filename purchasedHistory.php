...
<head>
    ...
    <title>Purchasing History | Pet Dreamland</title>
            ...
            ?>
                ...
                ?>
                    <div class="col-12 bg-body text-center" style="height: 450px;">
                        ...
                        <a href="home.php" class="btn btn-outline-warning fs-3">Start Shoping</a>
                    </div>
                <?php
                } else {
                ?>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 text-center text-lg-start">
                                            <label class="form-label text-dark fs-6 py-5"><?php echo $invoice_data["id"]; ?></label>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-1 text-center text-lg-end">
                                            <label class="form-label fs-5 py-5"><?php echo $invoice_data["qty"]; ?></label>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-secondary rounded border border-1 border-primary mt-5 fs-5" onclick="addFeedback(<?php echo $invoice_data['products_id']; ?>);">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary" onclick="saveFeedback(<?php echo $invoice_data['products_id'] ?>);">Save Feedback</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
