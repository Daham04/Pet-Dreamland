...
?>
    ...
    <head>
        ...
        <title>Admin Panel | Pet Dreamland</title>
                            ...
                            <div class="row g-1 text-center">
                                ...
                                <div class="nav flex-column nav-pills me-3 mt-3" role="tablist" aria-orientation="vertical">
                                    <nav class="nav flex-column">
                                        ...
                                        <a class="nav-link" href="manageproducts.php">Mange Products</a>
                                    </nav>
                                </div>
                                        ...
                                        <div class="col-12 bg-dark text-white text-center rounded" style="height: 100px;">
                                            ...
                                            for ($x = 0; $x < $invoice_num; $x++) {
                                                ...
                                                if ($pdate == $today) {
                                                    ...
                                                    $a = $a + $invoice_data["total"]; //total of sell products in month
                                                    $c = $c + $invoice_data["qty"]; //qty of sell products in month
                                                ...
                                                if ($pyear == $thisyear) {
                                                    if ($pmonth == $thismonth) {
                                                        ...
                                                        $b = $b + $invoice_data["total"]; //total of sell products in month
                                                        $e = $e + $invoice_data["qty"]; //qty of sell products in month
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                if ($freq_num > 0) {
                                    ...
                                    WHERE `products_id`='" . $freq_data["products_id"] . "' AND `date` LIKE '%" . $today . "%' ");
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center">
                                        <img src="<?php echo $image_data["code"] ?>" class="img-fluid rounded-top" style="height: 230px;">
                                    </div>
                                    <div class="col-12 text-center">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center">
                                        <img src="resources/empty.svg" class="img-fluid rounded-top" style="height: 230px;">
                                    </div>
                                    <div class="col-12 text-center">
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                if ($freq_num > 0) {
                                    ...
                                    $profille_data = $profile_rs->fetch_assoc();
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center">
                                        <img src="<?php echo $profille_data["path"] ?>" class="img-fluid rounded-top" style="height: 230px;">
                                    </div>
                                    <div class="col-12 text-center">
