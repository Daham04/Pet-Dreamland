...
if($category == "0"){
    ...
    (`category_id`,`price`,`qty`,`description`,`title`,`condition_id`,`status_id`,
    `user_email`,`datetime_added`,`delivery_fee_colombo`,`delivery_fee_other`,`brand_has_model_id`) VALUES 
    ('".$category."','".$cost."','".$qty."','".$desc."','".$title."','".$condition."','".$status."',
    '".$email."','".$date."','".$dwc."','".$doc."','".$model_has_brand_id."')");
