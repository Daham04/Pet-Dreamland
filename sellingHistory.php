...
<head>
    ...
    <title>Selling History | Admins | Pet Dreamland</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 text-center" style="background-color: burlywood;">
                <label class="form-label text-dark fw-bold fs-1">Selling History</label>
            </div>

            <div class="col-12 mt-3 mb-3" style="background-color: burlywood;">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-1 mt-3 mb-3 d-grid">
                        <button class="btn btn-dark fs-5 fw-bold" onclick="findSellings();">Find</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-1 bg-body text-end">
                        <label class="form-label fs-5 fw-bold text-black">Invoice ID</label>
                    </div>
            ...
            <div class="col-12 mt-2" id="viewArea">
                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-1 bg-body text-end">
                            <label class="form-label fs-5 fw-bold text-black mt-1 mb-1"><?php echo $selected_data["id"]; ?></label>
                        </div>
                        <?php
