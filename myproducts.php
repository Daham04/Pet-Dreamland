...
?>
    ...
    <head>
        ...
        <title>My Products | Pet Dreamland</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 mt-3 fs-5">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12 mx-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                                <button class="btn btn-dark bg-opacity-25 fw-bold text-center mt-1" onclick="window.location='addProduct.php'">Add Product</button>
                                            </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-lg-9 mt-3 mb-3 bg-white offset-1">
